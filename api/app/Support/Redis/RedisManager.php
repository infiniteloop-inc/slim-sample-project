...
/**
 * @see https://github.com/illuminate/redis/blob/master/RedisManager.php
 *
 * Copyright (c) Taylor Otwell
 * https://github.com/illuminate/redis/blob/master/LICENSE.md
 */
...
class RedisManager implements Factory
{
    ...
    public function resolve($name = null)
    {
        ...
        if (isset($this->config[$name])) {
            ...
            if ($connector === null) {
                throw new Exception("Redis driver [{$this->driver}] not configured.");
            }
    ...
    protected function resolveCluster($name)
    {
        ...
        return $connector->connectToCluster(
